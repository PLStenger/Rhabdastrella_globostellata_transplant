...
# Note: max-depth should be chosen based on ConTable.qzv (or on /home/fungi/Rhabdastrella_globostellata_transplant/05_QIIME2/export/visual/ConTable/sample-frequency-detail.csv)
